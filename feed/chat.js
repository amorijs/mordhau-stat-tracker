...
const authorizedPlayFabIDs = new Set(
    process.env.AUTHORIZED_ADMINS.trim().split(" ")
);
...
module.exports.process = async (rcon, message) => {
    ...
    const playFabID = splitMessage[0].split(" ")[1];
    const authorized = authorizedPlayFabIDs.has(playFabID);
